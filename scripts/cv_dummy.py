...
class Camera_dummy:
    def __init__(self):
        ...
        self.dist = np.array([-0.5539, 0.2666, -.005846, -.004422, .1288])
    ...
    def color_pose(self, color):
        try: os.remove("ah.png")
        except: print("No File Deleted")
        ...
        while id_found == False:
            ...
            h, w = frame.shape[:2]
            newcam, roi = cv.getOptimalNewCameraMatrix(self.k, self.dist, (w,h), 1, (w,h))
            ...
            if ret:
                ...
                if len(corners) > 0:
                    ...
                    if tag_found == True:
                        ...
                        ah, rvecs, tvecs = cv.solvePnP(obj_pts, corners, self.k, self.dist)
                        ...
                        print(type(T))
                        id_found = True
                        print([T[1][3]/self.in2m, T[0][3]/self.in2m, T[2][3]/self.in2m])
                        return [T[1][3]/self.in2m, T[0][3]/self.in2m, T[2][3]/self.in2m]